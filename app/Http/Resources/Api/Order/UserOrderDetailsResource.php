...
class UserOrderDetailsResource extends JsonResource
{
    ...
    {
        return [
            'address' => $this->address_id ? new UserAddressItemResource(UserAddress::query()->find($this->address_id)) : array_merge(json_decode($this->personal, true), json_decode($this->shipping, true)),
